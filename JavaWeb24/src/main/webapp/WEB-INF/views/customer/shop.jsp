			...
			<div class="header-content-left">
				<ul>
					...
					<form method="GET" action="${base}/shop" name="form">
						<li><span>Sắp xếp: <select name="sort_By">
							...
							</select> <select name="sort_direction" onchange="document.form.submit()">
									<option value="asc"><a href="">Mặc Định</a>
									</option>
									<option value="asc"><a href="">Tăng Dần</a>
									</option>
									<option value="desc"><a href="">Giảm Dần </a>
									</option>
